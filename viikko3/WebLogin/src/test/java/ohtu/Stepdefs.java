...
public class Stepdefs {
    ...
    @When("a correct username {string} and too short password {string} are entered")
    public void correctShortUsernameAndTooShortPasswordAreGiven(String username, String password) throws Throwable {
        createUserWith(username, password, password);
    }

    @When("a username {string} and password {string} and non-matching password confirmation {string} are entered")
    public void passwordConfirmationDoesntMatchPassword(String username, String password, String confirmation) throws Throwable {
    ...
    public void newUserLogsIn(String username, String password) {
        logInWith(username, password);
    }
